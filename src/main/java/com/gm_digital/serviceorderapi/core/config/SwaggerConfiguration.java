package com.gm_digital.serviceorderapi.core.config;
...
public class SwaggerConfiguration {
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.gm_digital"))
                .build()
                .apiInfo(getApiInfo())
    ...
    private ApiInfo getApiInfo() {
        return new ApiInfoBuilder()
                ...
                .description("API para autenticação das ordens de serviço.")
                .contact(new Contact("GM_DIGITAL", "", "borges.gm22@gmail.com"))
                .version("1.0.0")
                .build();
    }
